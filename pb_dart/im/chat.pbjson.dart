...
const $core.Map<$core.String, $core.dynamic> ChatServiceBase$json = {
  ...
  '2': [
    {
      '1': 'ChatStream',
      '2': '.chat.v1.ChatClientMessage',
      '3': '.chat.v1.ChatServerEvent',
      '5': true,
      '6': true
    },
    {
      '1': 'ListConversations',
      '2': '.chat.v1.ListConversationsRequest',
      '3': '.chat.v1.ListConversationsResponse'
    },
  ],
};
...
const $core.Map<$core.String, $core.Map<$core.String, $core.dynamic>>
  ...
  '.chat.v1.ChatClientMessage': ChatClientMessage$json,
  '.chat.v1.Auth': Auth$json,
  '.chat.v1.SendMessage': SendMessage$json,
  '.chat.v1.AckMessage': AckMessage$json,
  '.chat.v1.Heartbeat': Heartbeat$json,
  '.chat.v1.ChatServerEvent': ChatServerEvent$json,
  '.chat.v1.NewMessage': NewMessage$json,
  '.chat.v1.MessageAck': MessageAck$json,
  '.chat.v1.PresenceUpdate': PresenceUpdate$json,
  '.chat.v1.SystemEvent': SystemEvent$json,
  '.chat.v1.ListConversationsRequest': ListConversationsRequest$json,
  '.chat.v1.ListConversationsResponse': ListConversationsResponse$json,
  '.chat.v1.Conversation': Conversation$json,
  '.chat.v1.Member': Member$json,
};
...
final $typed_data.Uint8List chatServiceDescriptor = $convert.base64Decode(
    'CgtDaGF0U2VydmljZRJGCgpDaGF0U3RyZWFtEhouY2hhdC52MS5DaGF0Q2xpZW50TWVzc2FnZR'
    'oYLmNoYXQudjEuQ2hhdFNlcnZlckV2ZW50KAEwARJaChFMaXN0Q29udmVyc2F0aW9ucxIhLmNo'
    'YXQudjEuTGlzdENvbnZlcnNhdGlvbnNSZXF1ZXN0GiIuY2hhdC52MS5MaXN0Q29udmVyc2F0aW'
    '9uc1Jlc3BvbnNl');
